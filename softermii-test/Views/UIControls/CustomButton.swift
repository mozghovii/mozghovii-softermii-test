...
class CustomButton: UIButton {
    ...
    public func setCustomTitle(title: String,subtitle: String) {
        ...
        let attributeString = NSMutableAttributedString(string: substring1 as String, attributes:[NSFontAttributeName : UIFont.systemFont(ofSize: 14.0)])
        
        let attributeString1 = NSMutableAttributedString(string: substring2 as String, attributes:[NSFontAttributeName : UIFont.systemFont(ofSize: 10.0)])
